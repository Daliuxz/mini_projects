        ...
        <div className="bg-[#17494c]">
            <main className="flex gap-20 justify-between items-center max-w-4xl mx-auto text-white py-20">
                ...
                <div className="w-1/2">
                    <div>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet inventore a molestias reprehenderit? Laboriosam voluptates a aspernatur perspiciatis nostrum praesentium debitis dolores nemo illo impedit, ratione corporis nisi tenetur alias?
                        </p>
                    </div>
                    <div className="flex mt-5 gap-10">
                        <button className="bg-[#e4f0d3] p-3 text-[#03363e] font-medium">
                            Free Trial
                        </button>
                        <button className="border-2 border-white p-3 font-medium">
                            View demo
                        </button>
                    </div>
                </div>
