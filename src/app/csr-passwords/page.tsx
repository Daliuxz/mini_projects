...
import { SliderBar } from "@/components/passwords/SlideBar";
        ...
        <div className="bg-slate-100 w-full h-screen flex justify-center items-center">
            <div className="border border-gray-500 p-5 rounded bg-white">
                ...
                <div className="flex">
                    ...
                    placeholder="New password" className="border rounded p-2 my-2"/>
                    <button onClick={copyPassword} className="w-20 text-center flex justify-center items-center m-2 border rounded hover:cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-gray-400 hover:text-gray-600 hover:cursor-pointer">
            ...
            <div className="absolute bottom-5 right-5">
                { 
                    showMessage && (
                        <p className="flex gap-5 justify-between bg-green-500 text-white p-2 rounded w-full text-center mt-3 text-sm">
