                ...
                <section className="flex justify-between items-start">
                    ...
                    <div className="w-2/3">
                        <h2 className="font-bold text-2xl">
                            {character.name} <span className="font-normal text-gray-500 text-sm"> {character.race} </span>
                        </h2>
                    </div>
                    <p>
                            ...
                            <div className="flex gap-5 flex-wrap mt-10">
                                {
                                    character.transformations.map((transformation) => {
                                        return (<div key={transformation.id} className="text-center p-5 bg-slate-100 rounded">
